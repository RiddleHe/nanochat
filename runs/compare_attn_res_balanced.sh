...
# Compare GPT baseline, AttnRes, and AttnRes with load balancing loss.
#
# Usage:
#   DEPTH=12 NPROC_PER_NODE=4 bash runs/compare_attn_res_balanced.sh
#   DEPTH=24 NPROC_PER_NODE=4 bash runs/compare_attn_res_balanced.sh
...
MODEL_TYPES=("gpt" "attn_res" "attn_res_balanced")
...
log "=============================================="
log "AttnRes Balanced Comparison Complete (d=$DEPTH)"
log "=============================================="
