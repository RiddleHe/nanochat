...
Usage:
    python scripts/visualizations/plot_comparison.py --logs a.log b.log --labels "Model A" "Model B"
    python scripts/visualizations/plot_comparison.py --logs a.log b.log --labels "A" "B" --output out.png
"""
import re
import argparse
